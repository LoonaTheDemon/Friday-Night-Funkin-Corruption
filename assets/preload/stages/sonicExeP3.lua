...
function onCreate()
    ...
    makeAnimatedLuaSprite('plasticShit', 'exep3/NewTitleMenuBG', 0, -400)
    ...
    makeLuaSprite('bg', 'exep3/sonicFUNsky', -621, -365)
    addLuaSprite('bg', false)
    setGraphicSize('bg', getProperty('bg.width') * 1.2)

    makeLuaSprite('trees1', 'exep3/Trees3', -607, -301)
    addLuaSprite('trees1')
    ...
    makeLuaSprite('grass', 'exep3/Grass2', -630, -466)
